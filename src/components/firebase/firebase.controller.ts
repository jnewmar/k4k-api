...
export class FirebaseController {
    ...
    @Post('/user/:id/proposal')
    getProposals(@Param('id') user_id: string) {
        const ret = this.firebaseService.getUserProposals(user_id);
        return ret;
    }
    ...
    @Post('/kid/:id')
    getKid(@Param('id') id: string) {
        const ret = this.firebaseService.getKid(id);
        return ret;
    }
